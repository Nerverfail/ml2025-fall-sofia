...
def main():
    module5_mod.number_processor.initialize_n()

    module5_mod.number_processor.initialize_numbers(module5_mod.number_processor.number_size)

    module5_mod.number_processor.find_number()
